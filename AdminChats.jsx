...
export default function AdminChats() {
    ...
    return (
        <div className="flex h-screen bg-gray-50 font-sans overflow-hidden">
            {/* Left Sidebar */}
            <aside
                className={`bg-white border-r border-gray-200 flex flex-col items-center py-4 gap-5 z-10 shrink-0 overflow-hidden transition-all duration-300 ${sidebarOpen ? "w-14" : "w-0 border-r-0 py-0"
                    }`}
            >
